    ...
    <div style="padding:24px 32px;">
      ...
      <div style="background:${hasRefund ? "#f0fef4" : "#fef2f2"}; border:1px solid ${hasRefund ? "#50c878" : "#e74c3c"}; border-radius:8px; padding:20px 24px;">
        ...
        <p style="margin:12px 0 0; color:#555; font-size:12px;">
          ${hasRefund
              ? "Your refund will be credited to your original payment method within <strong>5-7 business days</strong>."
              : "No refund applicable as per the cancellation policy agreed at the time of booking."}
        </p>
      </div>
    </div>
