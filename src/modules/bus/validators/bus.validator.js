...
const HHmm = z
  .string()
  .regex(/^([01]\d|2[0-3]):[0-5]\d$/, "Must be in HH:mm format (e.g., 22:00)");
const objectId = z
  .string()
...
export const createRouteSchema = z.object({
  body: z.object({
    ...
    stops: z
      .array(stopSchema)
      .min(2, "At least 2 stops required (source and destination)"),
...
export const createScheduleSchema = z.object({
  body: z.object({
    ...
    arrivalDate: z
      ...
      .optional(),
    boardingPoints: z
      .array(boardingDroppingSchema)
      .min(1, "At least 1 boarding point required")
      .optional(),
    droppingPoints: z
      .array(boardingDroppingSchema)
      .min(1, "At least 1 dropping point required")
      .optional(),
